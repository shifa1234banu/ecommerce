;(function ($, window) {
     ...
     */
    function init() {
        .append("<div class='exzoom_img_ul_outer'></div>");
        exzoom_nav.append("<p class='exzoom_nav_inner'></p>");
        exzoom_img_ul_outer = .find(".exzoom_img_ul_outer");
...
<p class='exzoom_preview'>
    <img class='exzoom_preview_img' src='' />
            ...
            `);
        exzoom_zoom = .find(".exzoom_zoom");
        exzoom_main_img = .find(".exzoom_main_img");
        exzoom_zoom_outer = .find(".exzoom_zoom_outer");
        exzoom_preview = .find(".exzoom_preview");
        exzoom_preview_img = .find(".exzoom_preview_img");
